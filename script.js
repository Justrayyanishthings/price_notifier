document.addEventListener("DOMContentLoaded", function () {
  ...
  var headingLinks = document.querySelectorAll(".content ul li a");
  ...
  // Add click event listeners to the heading links
  for (var i = 0; i < headingLinks.length; i++) {
    headingLinks[i].addEventListener("click", function (event) {
      ...
      // If the target section is the same as the current section,
  ...
  // Show the initial section (first one)
  ...
  $('.logo-image').click(function () {
    ...
    topMiddleImage.html('<img class="top-middle-image" src="' + imagePath + '" alt="Logo">');
    // Calculate the horizontal offset for the image
  ...
  ////////////////////crypto/stocks page radio buttons/////////////
...
radioGroup.addEventListener('change', function() {
  ...
  const customCryptoDurationOption = document.querySelector('input[name="cryptomonitor"][value="cryptocustom-duration"]');
